...
test('Ollama request priorities keep player-facing work first', () => {
  ...
  assert.ok(OLLAMA_REQUEST_PRIORITIES.PLAYER_TASK_DECISION > OLLAMA_REQUEST_PRIORITIES.AUTONOMOUS_TASK_DECISION)
  assert.ok(OLLAMA_REQUEST_PRIORITIES.PLAYER_CONVERSATION > OLLAMA_REQUEST_PRIORITIES.AUTONOMOUS_TASK_DECISION)
  assert.ok(OLLAMA_REQUEST_PRIORITIES.AUTONOMOUS_TASK_DECISION > OLLAMA_REQUEST_PRIORITIES.LEARNING_REFLECTION)
